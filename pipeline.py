...
LUA_SHA1 = get_hash(os.path.join(CWD, 'deviantart.lua'))
...
class WgetArgs(object):
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'group':
                wget_args.extend(['--warc-header', 'deviantart-group-id: '+item_value])
                wget_args.append('https://www.deviantart.com/global/difi/?c%5B%5D=%22GrusersModules%22%2C%22findAndDisplayModule%22%2C%5B%22'+item_value+'%22%2C%22frontroom%22%2C%22joinrequest%22%2C%22generic%22%2C%7B%7D%5D&iid=0&mp=9&t=json')
            elif item_type == 'asset':
            	wget_args.extend(['--warc-header', 'devianart-asset: '+item_value])
            	wget_args.append('https://'+item_value)
            elif item_type == 'offset':
            	wget_args.extend(['--warc-header', 'devianart-offset-url: '+item_value])
            	wget_args.append('https://'+item_value)
            else:
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/7/7e/Deviantart-icon.png" height="50px" title=""/>
        <h2>DeviantArt <span class="links"><a href="https://www.deviantart.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/deviantart/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/DeviantArt">Wiki</a></span></h2>
        <p>Archiving DeviantArt legacy design data.</p>
    '''
)
